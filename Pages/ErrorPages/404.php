            ...
            <div class="item active inactiveUntilOnLoad">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <h1 data-animation="animated animate1 bounceInDown"><text style="color: #fa6767">Ошибка 404</text></h1></br>
                        <h3 class="text-bold text-white" data-animation="animated animate5 bounceInDown">По данному адресу ничего нет</h3>
                        <p data-animation="animated animate7 fadeInUp">По возможности сообщите Администрации о данной проблеме в теме: <a href="http://<?php echo $config['VK'] ?>"><text style="color: #ffd460"><?php echo $config['VK'] ?></text></p>
                            <a href="/"><button class="btn btn-warning btn-lg btn-rounded"><i class="fa fa-arrow-left"></i> На главную</button></a>
                    </div>
                </div>
            </div>
        </div>
