            ...
            <div class="item active inactiveUntilOnLoad">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <h1 data-animation="animated animate1 bounceInDown"><text style="color: #fa6767">Ошибка 401</text></h1></br>
                        <h3 class="text-bold text-white" data-animation="animated animate5 bounceInDown">Для доступа к данной страницы авторизируйтесь <a href="/go/auth"><text style="color: #5bc0de">здесь</text></a></h3>
                        <p data-animation="animated animate7 fadeInUp">Если у вас нет аккаунта, то зарегистрируйтесь на сервере <i><text style="color: #5bc0de">mc.lucky-cloud.ru</text></i></p>
